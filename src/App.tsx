    ...
    <div className="flex flex-col m-auto w-3/5">
      ...
      {beanNames.length > 0 ? (
        ...
        <div className="mt-10 mx-5 px-6 py-5 rounded-2xl border border-amber-200 bg-amber-50/80 text-amber-900 shadow-sm">
          ...
          <p className="mt-2 leading-relaxed">
            I can taste all pairings of 5 beans in 10 groups of 3 or 5 groups of
            4. Both ways compare each pairing 3 times, so there is a definite
            winner, but groups of 4 are easier to remember, i.e., exclude one
            bean at each tasting. Groups of 5 would work too, but I only have 4
            puck screens.
          </p>
        </div>
      )}
